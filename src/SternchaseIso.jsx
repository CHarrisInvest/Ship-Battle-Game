...
const MODES = {
  ...
  derby: {
    ...
    short: "derby",
    color: C.crew,
    desc: "Only one hand needed. Last afloat wins. 10 captains in ships that rival yours. No guns, no repairs. Sink rivals by ramming. Drive your bow into her beam, and turn to face anyone charging yours. Time afloat is paid and a storm closes in that takes the crew of any ship caught.",

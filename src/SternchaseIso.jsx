...
const MODES = {
  ...
  ffa: {
    ...
    short: "free-for-all",
    color: C.mast,
    desc: "Last afloat wins. 10 other captains with each ship rivaling your own, hunting for weak prey and turning on whoever pulls ahead. Spend what you take on repairs, or keep it. Time afloat is paid. A storm closes in and takes the crew of any ship caught.",
  ...
  derby: {
    ...
    short: "derby",
    color: C.crew,
    desc: "Only one hand needed. Last afloat wins. 10 captains in ships that rival yours. No guns, no repairs. Sink rivals by ramming. Drive your bow into her beam, and turn to face anyone charging yours. Time afloat is paid. A storm closes in and takes the crew of any ship caught.",

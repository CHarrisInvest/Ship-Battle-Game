 ...
 * that rung, so the card says what to do next rather than what the ladder is.
 */
export function progressOf(a, hold) {
  ...
  return { id: a.id, count: Math.min(raw, goal), goal, rung, rungs: goals.length, done, blurb };
}
